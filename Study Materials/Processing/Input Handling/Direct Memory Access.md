...
## DMA Process
1. The processor hands over to the DMAC (DMA Controller) an address in [[Memory]], an address of the peripheral device, type of action (read/write) and the amount of transferred [[Processor Word]]s.
