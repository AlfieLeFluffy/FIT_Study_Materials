...
- **Primary** (Internal) memory is further split into based on its position in relation to the [[Microprocessor|processor]]:
	- **Inside processor** which consists of registers, [[cache]], ([[Cache]], usually several layers)
	- **Outside processor** which consists of [[Random Access Memory]]
...
**By data access:**
- **Random** access ([[Random Access Memory]]) does not restrict what part of the memory can be accessed and so any part can be worked with at any time.
