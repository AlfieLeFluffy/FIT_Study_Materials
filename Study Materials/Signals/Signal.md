...
sources:
---
A **signal** is intentional **physical phenomenon**, that **carries information** about some kind of an event. It is a time and space variable (physical variable). A signal can be analysed and modified through [[Spectral Analysis|spectral analysis]].
## Types
Types of signals depend on their time and value discretion/continuity.
### Continuous
