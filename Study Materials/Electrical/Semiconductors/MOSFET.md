...
![[MOSFET_Diagrams.excalidraw.svg]]
## Princip
### N-Channel example
For example of the principal, an N-channel enhancement MOSFET has are two N-type electrodes (nodes) imbedded into a substrate (body) made from P-type. There is not direct connection between the N-type electrodes. 
![[N-channel_MOSFET_Closed.excalidraw.svg]]
...
### N-Channel example
This principal is also the same principal for the P-channel MOSFETS, but in reverse. 
![[P-channel_MOSFET_Closed.excalidraw.svg]]![[P-channel_MOSFET_Open.excalidraw.svg]]
## Performance
