...
aliases:
  - language
---
If **Σ\*** is a [[Set]] of all possible [[Study Materials/Automata/Terms/Word|strings]] **w** over [[Alphabet|alphabet]] **Σ**, then each subset **L ⊆ Σ\*** is a language over the alphabet **Σ**. These subsets are then sets of strings made up of the alphabet. The **amount of words** of a language is its cardinality. 
## Types
