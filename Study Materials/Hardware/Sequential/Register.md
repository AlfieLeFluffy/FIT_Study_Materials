...
- They can have asynchronous clearing through **[[Clear Signal]]** signal and they can have an enable (control) signal **[[Chip Enable]]**.
...
- They are commonly used in construction of [[Automata]]s to represent the current state.
## Memory Register (Latch)
Basic memory register that stores bits, usually some variation of 2<sup>N</sup> number.
## Shift Register
Synchronous circuit using [[Clock Signal]] made out of [[Flip-Flop]]s configured in a series. In operation they move one bit of information to left or right with every [[Clock Signal]] impuls. They have a Data in input and Data out output on the ends of the register space, arranged depending on what direction the counter should be counting in.
...
- Data buffer for [[Universal Asynchronous Reciever-Transmiter]] before being sent
- Data buffer for [[Universal Asynchronous Reciever-Transmiter]] for receiving data
