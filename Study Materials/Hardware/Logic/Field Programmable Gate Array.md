...
- **Description of Circuits as a General [[Automata]].** The SM should describe all the states of the circuit , but does not resolve configuration of control, input or output signals.
...
- **Design of the Control State Machine.** Conversion of the General SM into a [[Automata#Mealy's SM|Mealy's State Machine]] or a [[Automata#Moore's SM|Moore's State Machine]] that control the data paths. 