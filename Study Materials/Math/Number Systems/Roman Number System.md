...
Originally numbers such as **4** were writen as **IIII** and 40 as **XXXX**, which allowed for the symbols to be in any order. The more commonly used system of subtracting numbers, such as **4** represented as **IV**, was started to be used later during medieval age and it complicates the position of symbols within the number [[String|string]].
